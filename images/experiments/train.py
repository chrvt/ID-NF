...
if __name__ == "__main__":
    ...
    #sig2_0 = 1e-09 ###255**1 * 1e-12   ##     300                       ##Stylegan64d 200 epochs unbounded: n=30   sig2_0 = 255**1 * 1e-12 | sig2_1 = 255**1 * (255.0 * 255.0)
    #sig2_1 = 2.0 ####255**1 * (255.0 * 255.0) ## 10000                    ##Stylegan2d  100 epochs clamped:   n=20   sig2_0 = 255**1 * 1e-12 | sig2_1 = 255**2 
    ...
    ###for images
    sigmas = [1e-09, (0.68 * 255.0)**2, (100*255.0)**2 ]
